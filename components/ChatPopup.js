...
export default function ChatPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center md:items-center sm:items-end justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-md mx-auto mt-12 sm:mb-20">
